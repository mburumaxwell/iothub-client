...
public:
	IotHubAuthenticationWithTpm(char *hostname = NULL, char *device_id = NULL, uint32_t ttl_sec = MBED_CONF_IOTHUB_SAS_DEFAULT_TTL_SEC);
	IotHubAuthenticationWithTpm(IotHubConnectionString *cs, uint32_t ttl_sec = MBED_CONF_IOTHUB_SAS_DEFAULT_TTL_SEC);
